# Music Library Optimizer v1.5.3
...
**Desktop app (installer):** Download `MusicLibraryOptimizer_Setup_v1.5.3_x64.exe`
...
**Portable:** Download `MusicLibraryOptimizer_v1.5.3_portable_x64.exe` and run it
...
```
app.py                          GUI entry point (Tkinter, dark-themed) — v1.5.3
...
mlo/                            Core package — all processing logic
    ...
    config.py                   config.json load/save & defaults (v1.5.3 keys, ENCODER_PROGRAM off, no tag deletion)
...
RELEASE_NOTES.md                v1.5.3 + v1.5.3 + v1.5.0 + v1.4.3 + v1.4.2 + v1.4.1 + v1.4.0 + v1.3.9 + v1.3.8 + v1.2.0 + v1.1.0 summary (current)
...
Output: `dist/MusicLibraryOptimizer_Setup_v1.4.2_x64.exe` + `dist/MusicLibraryOptimizer_v1.5.3_portable_x64.exe` + `dist/mlo.exe`
